...
class MovieFinalApplicationTests extends AbstractTest {
	...
	/*
	 * @Test public void viewCustomerList() throws Exception {
	 * loginController.loginUser("sunayana", "sunayana123"); String uri =
	 * "/customer/findall"; MvcResult mvcResult =
	 ...
	 * content = mvcResult.getResponse().getContentAsString(); Customer cu[] =
	 * super.mapFromJson(content, Customer[].class);
	...
	/*
	 * @Test public void findTheatres() throws Exception { String uri =
	 * "/theatre/find/4"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Theatre Th =
	 * super.mapFromJson(content, Theatre.class); assertEquals("Kabuki",
	 * Th.getTheatreName()); }
	 */
	...
	/*
	 * @Test public void deleteMoviesById() throws Exception {
	 * loginController.loginUser("sunayana", "sunayana123"); String
	 * uri="/movies/delete/34"; MvcResult
	 * mvcResult=mvc.perform(MockMvcRequestBuilders.delete(uri)).andReturn(); int
	 * status=mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Movie mv
	 * =super.mapFromJson(content, Movie.class);
	...
	/*
	 * @Test public void viewMovie() throws Exception { String uri =
	 * "/movies/viewMovie/5"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(201, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Movie mv =
	 * super.mapFromJson(content, Movie.class); assertEquals(5, mv.getMovieId()); }
	 */

	/*
	 * @Test public void viewMovieList() throws Exception { String uri =
	 * "/movies/findall"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Movie mv[] =
	 * super.mapFromJson(content, Movie[].class); assertEquals("Avengers",
	 * mv[mv.length-1].getMovieName()); }
	 */
	...
	/*
	 * @Test public void viewScreenList() throws Exception {
	 * loginController.loginUser("sunayana", "sunayana123"); String uri =
	 * "/screens/findall"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Screen sc[] =
	 * super.mapFromJson(content, Screen[].class); assertEquals("screen2",
	 * sc[sc.length-1].getScreenName()); }
	 */
	...
	/*
	 * @Test public void viewShowList() throws Exception { String uri =
	 * "/shows/findall"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Show sh[] =
	 * super.mapFromJson(content, Show[].class); assertEquals("MorningShow",
	 * sh[sh.length-1].getShowName()); }
	 */

	/*
	 * @Test public void viewAllBookings() throws Exception { String uri =
	 * "/booking/findall"; MvcResult mvcResult =
	 * mvc.perform(MockMvcRequestBuilders.get(uri)).andReturn(); int status =
	 * mvcResult.getResponse().getStatus(); assertEquals(200, status); String
	 * content = mvcResult.getResponse().getContentAsString(); Booking bo[] =
	 * super.mapFromJson(content, Booking[].class); assertEquals("Online",
	 * bo[0].getTransactionMode()); }
	 */
